    ...
    <div className="">
      ...
      <div className="mx-2 my-8 lg:max-w-1920 lg:m-auto lg:px-48 lg:my-20">
        <p>
          ...
          provide a fair and flexible cancellation policy to accommodate your
        ...
        <div className=" mt-4">
          ...
          <p>
            ...
            please note that orders that have already been processed or shipped
        ...
        <div>
          ...
          <p>
            ...
            note that different subscription plans may have varying cancellation
            terms and notice periods. It is important to review the specific
            terms of your subscription for cancellation requirements
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            team for more information on refund eligibility and processing
            timelines.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            subscription process, and the applicable cancellation terms will be
            communicated to you.
          </p>
        </div>
