...
const FAQPage = () => {
  return (
    <div className="max-w-1920 m-auto">
      <div className="text-3xl flex justify-center text-[40px] py-10 font-bold">
        Frequently Asked Questions
      </div>

      <div className="border-2 border-white w-3/5 m-auto p-8">
        <p className="text-xl mb-4">
          How do I access the fitness videos on the site?
        </p>
        <p>
          To access the fitness videos, simply sign up for a membership on our
          site. Once you have registered, you can log in using your credentials
          and navigate to the video library, where you will find a wide range of
          workout videos to choose from.
        </p>
      </div>
      ...
      <div className="border-2 border-white w-3/5 m-auto p-8 my-4">
        ...
        <p>
          ...
          tablets, and smart TVs. Simply log in to your account on any of these
          devices, and you'll have access to the entire video library.
        </p>
      </div>
      ...
      <div className="border-2 border-white w-3/5 m-auto p-8 my-4">
        ...
        <p>
          ...
          and goals. Our video library includes workouts suitable for beginners,
          intermediate, and advanced fitness enthusiasts. You can filter the
          videos based on your fitness level or choose from beginner-friendly
          programs designed to help you get started on your fitness journey.
        </p>
      </div>
      ...
      <div className="border-2 border-white w-3/5 m-auto p-8 my-4 mb-20">
        ...
        <p>
          ...
          schedules and preferences. Our video library includes workouts ranging
          from quick 10-minute sessions for those with limited time to longer,
          more comprehensive workouts for those who prefer more intense
          training. You can choose the duration that suits your needs and fits
